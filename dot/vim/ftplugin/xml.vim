...
" Last Change:	$Date: 2004/05/18 05:42:21 $
...
"     if &filetype == 'xml' || (!exists ("g:did_xhtmlcf_inits") && exists ("g:xml_use_xhtml") && (&filetype == 'html' || &filetype == 'tt2html' || &filetype == 'xhtml'))
...
function s:ParseTag( )
    ...
    execute "normal! \"xy%%"
    let ltag = @"
    if (&filetype == 'html' || &filetype == 'xhtml' || &filetype == 'tt2html') && (!exists ("g:xml_no_html"))
	let html_mode = 1
